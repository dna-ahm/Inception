...
* A web server with NGinx
  ...
  - The server waits/listens for a connexion/request, sent via a transport protocol (TLS)
  ...
  Now on which port will the server listen? Or which transport protocol will it accept? This il all defined in a configuration file, usually named something like
